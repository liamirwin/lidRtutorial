...
[lidRbook](https://r-lidar.github.io/lidRbook/engine.html#engine-clip)
...
```{r exercises_and_questions, warning=FALSE, message=FALSE}
...
This concludes our tutorial on selecting simple geometries and extracting complex geometries from shapefiles using the `lidR` package in R. The code snippets are labeled for easy reference in the tutorial.
